...
public class ProjectLoader_v2 : IProjectLoader
{
    ...
    private void InitializeDeserialization()
    {
        _deserializer = new DeserializerBuilder()
            ...
            .WithAttributeOverride(typeof(DefaultSettings), nameof(DefaultSettings.PowerShellExe), new YamlMemberAttribute { Alias = "PowershellExe" })
            .WithAttributeOverride(typeof(DefaultSettings), nameof(DefaultSettings.PowerShellExecutionPolicy), new YamlMemberAttribute { Alias = "PowershellExecutionPolicy" })
            .WithAttributeOverride(typeof(DefaultSettings), nameof(DefaultSettings.UsePowerShellCore), new YamlMemberAttribute { Alias = "UsePowershellCore" })
            .WithAttributeOverride(typeof(DefaultSettings), nameof(DefaultSettings.UsePowerShellProfile), new YamlMemberAttribute { Alias = "UsePowershellProfile" })
    ...
    private void TransferWindowSettings(ViewModel.WindowSettings target, WindowSettings source)
    {
        target.Mode = (ViewModel.WindowMode)(source?.Mode ?? WindowMode.Default);
