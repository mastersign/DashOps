...
internal static class UserInteraction
{
        ...
        Window owner = null)
    {
        new UI.MessageBox
        {
            ...
            CloseButtonText = Properties.Resources.Common.MessageBox_OK,
        ...
        Window owner = null)
    {
        var msgBox = new UI.MessageBox
        {
            ...
            PrimaryButtonText = Properties.Resources.Common.MessageBox_Yes,
            IsPrimaryButtonEnabled = true,
            CloseButtonText = Properties.Resources.Common.MessageBox_No,
            Icon = new BitmapImage(new Uri("pack://application:,,,/DashOps;component/icon.ico")),
            ShowInTaskbar = showInTaskbar,
            Owner = owner,
            WindowStartupLocation = WindowStartupLocation.CenterOwner,
